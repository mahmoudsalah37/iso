...
class AuditorsListPage extends StatefulWidget {
  _AuditorsListPageState createState() => _AuditorsListPageState();
}

class _AuditorsListPageState extends State<AuditorsListPage> {
  String _textSearch;
  bool _isCheck = false;
  @override
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.only(top: 8.0),
            child: Text('Auditing Qualifications'),
          ),
          TextField(),
        ],
      ),
